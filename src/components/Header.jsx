  ...
  return (
    <div id="opening" className="shadow">
      ...
      <p>
        ...
        ask? Well, you provide us with the ingredients (at least 5 please-we're good but we can't work miracles!), and we provide the recipe.
        It really is that simple. So if you're ready to go lets stop the waste and start the taste.
      </p>
      </div>
      <div id="headerImg">
